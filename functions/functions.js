// false null undefuned "" '' 0
//function makeOmlette(argument 'string'  or value, argument2){
// סדר הפקודות שיוצרות את הפונקציה 
//console.log('bla bla'+ argument +'bla bla')
//const user = argument+argument2
//return user
//}
// הרצת הפונקציה
//void function בלי return
//makeOmelette(argument,argument2);
// non void with return
//const = makeOmelette(argument,argument2)
